...
//   const draftMode = cookieStore.get('draftMode')?.value === 'true';

//   // Fetch products and chefs based on draftMode
//   const foodQueryFinal = draftMode ? foodQuery + '&draft=true' : foodQuery;
//   const chefQueryFinal = draftMode ? chefQuery + '&draft=true' : chefQuery;

//   const productResponse = await sanityFetch({ query: foodQueryFinal });
//   const chefResponse = await sanityFetch({ query: chefQueryFinal });
